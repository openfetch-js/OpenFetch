 ...
 */
export async function resolveFetchDispatcher(config) {
    ...
    try {
        ...
        throw new OpenFetchError("OpenFetch: `allowH2: true` requires the `undici` package (dynamic import failed). Install: npm i undici", { config, code: "ERR_UNDICI_REQUIRED" });
    }
